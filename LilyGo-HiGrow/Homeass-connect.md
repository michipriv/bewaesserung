...
- URL: `http://higrow.local/rpc/mada.GetStatus`
...
2. **Home Assistant erkennt:**
   ...
   - HA ruft `http://higrow.local/mada` ab zur Identifikation
   - Gerät wird in HA angelegt

### Im laufenden Betrieb

**Alle 30 Sekunden - Automatisch:**
1. HA sendet: `GET http://higrow.local/rpc/mada.GetStatus`
